...
function getImageUrl (url, config, item, index, containerSize) {
  ...
  url = parts.baseUrl + parts.path + parts.filename
...
function setMouseEvents () {
  ...
  var startX
  backgroundImages.addEventListener('touchstart', function (event) {
    startX = event.changedTouches[0].pageX
  })

  backgroundImages.addEventListener('touchend', function (event) {
